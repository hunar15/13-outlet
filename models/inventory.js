...
exports.getDiscontinued = function (callback) {
	...
	result['metadata'].push({"name": "i.stock", "label" : "Stock", "datatype" : "double(,0,comma,dot,1,n/a)"});
	result['metadata'].push({"name": "i.min_stock", "label" : "Min. Stock", "datatype" : "double(,0,comma,dot,1,n/a)"});
	result['metadata'].push({"name": "i.selling_price", "label" : "Selling Price", "datatype" : "double($,2,comma,dot,1,n/a)"});
	result['metadata'].push({"name": "p.cost_price", "label" : "Cost Price", "datatype" : "double($,2,comma,dot,1,n/a)"});
...
exports.getInventory =  function(callback) {
	...
	result['metadata'].push({"name": "stock", "label" : "Stock", "datatype" : "double(,0,comma,dot,1,n/a)"});
	result['metadata'].push({"name": "min_stock", "label" : "Min. Stock", "datatype" : "double(,0,comma,dot,1,n/a)"});
	result['metadata'].push({"name": "selling_price", "label" : "Selling Price", "datatype" : "double($,2,comma,dot,1,n/a)"});
	result['metadata'].push({"name": "cost_price", "label" : "Cost Price", "datatype" : "double($,2,comma,dot,1,n/a)"});
