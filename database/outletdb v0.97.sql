...
--
-- Host: localhost
-- Generation Time: Dec 03, 2012 at 07:16 AM
...
ALTER TABLE `request_details`
  ADD CONSTRAINT `request_details_ibfk_6` FOREIGN KEY (`barcode`) REFERENCES `product` (`barcode`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `request_details_ibfk_5` FOREIGN KEY (`date`) REFERENCES `batch_request` (`date`) ON DELETE CASCADE ON UPDATE CASCADE;
